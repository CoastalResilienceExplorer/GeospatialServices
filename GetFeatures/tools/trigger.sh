...
curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_1_100HL_0SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/HL_0SLR.zip

curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_1_100HL_05SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/HL_05SLR.zip

curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_1_100HL_1SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/HL_1SLR.zip

curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_noHL_0SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/noHL_0SLR.zip

curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_noHL_05SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/noHL_05SLR.zip

curl -X POST http://localhost:3002/san_mateo/ \
   -H "Content-Type: application/json" \
   -d '{"features_file": "supporting-data2/google-microsoft-open-buildings.parquet/country_iso=USA/", "rasters": ["cloud-native-geospatial/san-mateo-2/OPC/flooddepth_noHL_1SLR.tif"], "rps": [1], "mode": "SAN_MATEO" }' > /Users/chlowrie/Desktop/OPC/outputs/noHL_1SLR.zip